...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1772770145464-k21wwd | 2026-03-06T04:09:05.797Z

**Codebase Map:**
  scripts/: hardhat.config
  contracts/: hardhat.config
  tests/: 00_deploy_token, hardhat.config, deploy, compatibility.test, ethers_compatibility.test, hardhat_instruction.test, uniswap.test, viemFunctions.test, web3js_compatibility.test, counter
