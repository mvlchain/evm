...
import (
	...
	"github.com/cosmos/evm/tadad"
	"github.com/cosmos/evm/tadad/config"
	customnetwork "github.com/cosmos/evm/tadad/tests/network"
...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "tadad", "Home directory of the node's daemon configuration")
