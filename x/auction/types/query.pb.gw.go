...
var (
	pattern_Query_Auction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1, 1, 0, 4, 1, 5, 3}, []string{"cosmos", "auction", "v1", "auction_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Auctions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "auction", "v1", "auctions"}, "", runtime.AssumeColonVerbOpt(false)))
)
